...
func RadialGlow(sl *pptx.Slide, box pptx.Box, alpha int, _ float64, role pptx.ColorRole, _ pptx.EMU) int {
...
func GlowRing(sl *pptx.Slide, box pptx.Box, alpha int, _ float64, role pptx.ColorRole, _ pptx.EMU) int {
	sl.AddShape(pptx.ShapeEllipse, box, pptx.WithFill(pptx.RadialGradient(
